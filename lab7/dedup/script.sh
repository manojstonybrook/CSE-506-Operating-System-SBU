...
case $choice in
     ...
     case $filename1 in
          0)
	   ../Debug/dedup4 store ecoli1_w.fasta | tee --append log.txt
     	   ;;
          *)
     ...
     ;;  	
     2)
     echo "Enter the name of file you want to read(the test file is named ecoli1_w.fasta):"
     read filename2
     echo "Enter the name of file, you want to dump the data from file read or press 0 for default name:"
     read filename3
     case $filename3 in
 	  0)
     ...
     case $filename4 in
          0)
	   ../Debug/dedup4 cac ecoli1_w.fasta | tee --append log.txt
     	   ;;
          *)
