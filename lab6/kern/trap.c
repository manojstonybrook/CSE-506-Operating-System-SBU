	...
	// LAB 4: Your code here.
	 ...
	 if(curenv->env_pgfault_upcall)
	 {
	   if(tf->tf_rsp < UXSTACKTOP && tf->tf_rsp > UXSTACKTOP-PGSIZE)
	     uxtf = (struct UTrapframe *)((void *)tf->tf_rsp - sizeof(struct UTrapframe)- 8);
	   else
	     uxtf = (struct UTrapframe *)((void *)UXSTACKTOP - sizeof(struct UTrapframe));
	  ...
	  uxtf->utf_fault_va = fault_va;
	   ...
	   //Important
	  user_mem_assert(curenv, (void *)uxtf, sizeof(struct UTrapframe), PTE_W);
